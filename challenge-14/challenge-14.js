...
*/
console.log( '\nOperation:' );
var operation = justMod2Or3.reduce(function(acu, actual){
  return (acu + 1) * actual
},0)
...
var operation2 = justMod2Or3.reduceRight(function(acu, actual){
  return (acu + 1) * actual
},0)
...
var name = ['Gui', 'lher', 'me']
var reduceP = name.reduce(function(acu, atual){
...
*/
console.log( '\nInversed Name:' );
var inversedName = name.reduceRight(function(acu, atual) {
return acu + atual
});
