...
var arr = ['Guilherme', 24, true, null, {object:'teste'}]
...
console.log( '\nMais estados adicionados:' );
  ...
  brasil.unshift('Acre', 'Amapa', 'Roraima')
  console.log(brasil)
...
*/
var nordeste = ['Bahia', 'Maranhão', 'Ceará']
...
*/
  var newBrasil = []
  brasil.forEach(function(item, ind) {
  newBrasil.push({id: ind, estado: item})    
  })
