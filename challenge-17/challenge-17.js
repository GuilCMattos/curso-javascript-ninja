...
text = text.replace(/Manuel Marques de Sousa/, 'Guilherme Carvalho de Mattos')
console.log(text)
...
text = text.replace(/brasileiro/, 'cubatense')
console.log(text)
...
console.log(text.replace(/(O Centauro de Luvas)/, function(capturaTotal, frase){
...
var months = arrMonths.map(function(item, indice) {  
    return {name:item, number: indice  > 8 ? String((indice + 1)) : String('0'+ (indice+1)) }
})
...
console.log('O mês de ' + months[2].name +' é representado pelo número '+ getMonthNumber('Março') )
console.log('O mês de ' + months[8].name +' é representado pelo número '+ getMonthNumber('Setembro') )
console.log('O mês de ' + months[11].name +' é representado pelo número '+ getMonthNumber('Dezembro') )
