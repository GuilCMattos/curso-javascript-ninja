...
*/
var five = Number('5'); // Ou eu mudava o '5' para 5
console.log( five + ' é número?', typeof five === 'number' );

var concat = String('10 + 10'); // Ou eu mudava o 10 + 10 para '10 + 10' 
...
*/
function showOperationMessage(operation, num1, num2) { 
  return `A operação ${num1} ${operation} ${num2} =`
...
function showErrorMessage(operator) {
  ...
  return 'Operação ' + operator + ' permitida!' 
}
...
*/
  number1 = 523 
  number2 = 714
  console.log(showOperationMessage(operationSignal,number1,number2), sum(number1,number2), showErrorMessage(operationSignal))
